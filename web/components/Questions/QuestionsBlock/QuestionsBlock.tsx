                ...
                }
                {
                    ...
                    : <div className={styles.filmBlock}>
                        <Image className={styles.photoImg} draggable='false'
                            loader={() => data.photoQuestions ? process.env.NEXT_PUBLIC_DOMAIN + data.photoQuestions : ''}
                            src={data.photoQuestions ? process.env.NEXT_PUBLIC_DOMAIN + data.photoQuestions : ''}
                            alt='photo3 img'
                            width={1}
                            height={1}
                            priority={true}
